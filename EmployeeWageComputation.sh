...
function dayAndDailyWagesWithTotalWage()
{
	echo "Day along with wages="
	echo "$day"
	for (( counter=1;counter<=20;counter++ ))
	do
		oneDayWage=$(( $(($wagePerHour*$fullDayHours))*$counter ))
		echo "Day $counter= $oneDayWage"
	done
}
